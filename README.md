...
Blazor scaffold. [src/Web](src/Web) still only contains the default Home, Counter, and
Weather sample pages generated by the project template — no GitHub Issues/Projects
domain logic has been implemented yet.
...
- [src/Web](src/Web) — the Blazor UI project (currently the default sample pages).
...
| 2026-09-11 | [fix(web): correct app.css asset path and render mode](docs/blogs/2026-09-11-pr-20-fix-web-correct-app-css-asset-path-and-render-mode.md) | release,automation |
<!-- BLOG_END -->
